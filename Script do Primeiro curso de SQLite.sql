...
(id_cliente,
 ...
 endereço_cliente)
 values
 ('1', 'Julia Arce', 'juliaarce@gmail.com', 'Meu Coração');
...
(id_cliente,
 ...
 endereço_cliente)
 VALUES
 ('2', 'Vitória Melodie', 'vitoriamelodie@gmail.com', 'Coração da Arce'),
 ('3', 'Nix', 'nixkenga@gmail.com', 'Coração de ArceMelodie'),
 ('4', 'Marluce Arcelino', 'marlucearcelino@gmail.com', 'Coração de ArceMelodie');
...
(ID_pedido_gold,
 ...
 update tabelaclientes set informacoes_de_contato = 'niquinha@gmail.com' where id_cliente = 3;
 
 update tabelaclientes set endereço_cliente = 'Rua dos Paralelepípedos, 30' where id_cliente = 5;
